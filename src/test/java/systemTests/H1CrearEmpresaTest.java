...
public class H1CrearEmpresaTest {
	  ...
	  public void testRegistrarEmpresaMalFormatoDeCampos() throws Exception {
	    ...
	    driver.findElement(By.linkText("Crear cuenta")).click();
	    driver.findElement(By.id("pills-profile-tab")).click();
	    driver.findElement(By.id("nombreEmpresa")).click();
	    driver.findElement(By.id("nombreEmpresa")).clear();
	    driver.findElement(By.id("nombreEmpresa")).sendKeys("a");
	  ...
	  public void testRegistroEmpresaCorrecto() throws Exception {
	    ...
	    driver.findElement(By.id("nombreEmpresa")).click();
	    driver.findElement(By.id("nombreEmpresa")).clear();
	    driver.findElement(By.id("nombreEmpresa")).sendKeys("Prueba");
	    driver.findElement(By.id("cif")).click();
	    driver.findElement(By.id("cif")).clear();
